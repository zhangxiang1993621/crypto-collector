...
whenToUse: when stuck and unsure which problem-solving technique to apply for your specific type of stuck-ness
---
...
2. **Load that skill** - Use DSH `skill({ name: "<skill>" })` for the specific technique
